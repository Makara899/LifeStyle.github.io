...
if (isset($_SESSION['admin_id'])) {
    ...
    $sql = "SELECT name, email, password FROM admin WHERE id = '$admin_id'";
    $result = $conn->query($sql);
        ...
        <div class="content">
            ...
            <div id="settings-section" class="dashboard-section">
                ...
                <div class="profile-card">
                    <div class="avatar"><?php echo !empty($admin_data['name']) ? strtoupper(substr($admin_data['name'], 0, 1)) : 'A'; ?></div>
                    <div class="info">
                        <h5>Admin Profile</h5>
                        <p><span class="label">Name:</span> <?php echo !empty($admin_data['name']) ? htmlspecialchars($admin_data['name']) : 'Not set'; ?></p>
                        <p><span class="label">Email:</span> <?php echo !empty($admin_data['email']) ? htmlspecialchars($admin_data['email']) : 'Not set'; ?></p>
                        <p><span class="label">Password:</span> <?php echo !empty($admin_data['password']) ? '••••••••' : 'Not set'; ?></p>
                    </div>
                </div>
